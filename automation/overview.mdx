...
description: "Learn about Intellixent's built-in automation engine for creating workflows without coding"
---
...
Intellixent includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Intellixent (e.g., "call ended," "inbound call context injection").
