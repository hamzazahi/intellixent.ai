...
title: "Cost Overview"
icon: "dollar-sign"
description: "Understand the main components of Intellixent pricing, including call minutes, number rentals, and optional fees"
---

Intellixent uses a **credit/minute system** to track usage for both AI processing and carrier network fees. Here's how it breaks down:
...
2. **Acquire or Verify a Number**: Rent from Intellixent or add your own as caller ID for outbound.
