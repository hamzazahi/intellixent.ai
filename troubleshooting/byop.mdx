...
description: "Learn how to use your existing phone numbers or Twilio account with Intellixent through SIP integration or Caller ID verification"
---
...
- Inbound & outbound will flow through your existing lines, but still utilize Intellixent's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through Intellixent or using a custom approach.
