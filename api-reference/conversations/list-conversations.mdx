...
response = requests.get(
    'https://portal.intellixent.ai//api/user/conversations',
...
```json 200 Response
{
  ...
  "first_page_url": "https://portal.intellixent.ai//api/user/conversations?page=1",
  "from": 1,
  "last_page": 5,
  "last_page_url": "https://portal.intellixent.ai//api/user/conversations?page=5",
  "links": [
    {
      "url": null,
    ...
    {
      "url": "https://portal.intellixent.ai//api/user/conversations?page=1",
      "label": "1",
      "active": true
    },
    {
      "url": "https://portal.intellixent.ai//api/user/conversations?page=2",
      "label": "2",
      "active": false
    }
  ],
  "next_page_url": "https://portal.intellixent.ai//api/user/conversations?page=2",
  "path": "https://portal.intellixent.ai//api/user/conversations",
  "per_page": 15,
  "prev_page_url": null,
  "to": 15,
  "total": 68
